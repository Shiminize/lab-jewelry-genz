...
import { NavigationSelector } from '@/components/navigation/NavigationSelector'
...
export default function NavigationDemoPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Navigation Selector with Demo */}
      <NavigationSelector showSelector={true} />
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center space-y-6 mb-16">
            ...
            <p className="text-gray-600 bg-background font-body text-lg lg:text-xl max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-foreground bg-white font-semibold text-lg">Volume-First Discovery</h3>
              </div>
              ...
              <div className="space-y-2">
                <h4 className="text-foreground bg-white font-medium text-sm">Key Features:</h4>
                <div className="space-y-1">
                  {[
                    ...
                    <div key={index} className="flex items-center space-x-2 text-xs text-gray-600 bg-white">
              ...
              <div className="pt-3 border-t border-gray-100">
                <div className="text-xs text-gray-500">Best for: Conversion optimization & direct sales</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-foreground bg-white font-semibold text-lg">Creator-Led Discovery</h3>
              </div>
              ...
              <div className="pt-3 border-t border-gray-100">
                <div className="text-xs text-gray-500">Best for: Brand building & trust development</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-foreground bg-white font-semibold text-lg">Smart Value Navigation</h3>
              </div>
              ...
              <div className="pt-3 border-t border-gray-100">
                <div className="text-xs text-gray-500">Best for: Personalization & retention</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8">
            <h2 className="text-foreground bg-white font-headline font-bold text-2xl lg:text-3xl mb-6">
              Success Metrics
            </h2>
            
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center space-y-2">
                <div className="text-3xl font-bold text-cta bg-white">+35%</div>
                <div className="text-sm text-gray-600 bg-white">Moissanite Page Visits</div>
              </div>
              <div className="text-center space-y-2">
                <div className="text-3xl font-bold text-accent bg-white">+40%</div>
                <div className="text-sm text-gray-600 bg-white">3D Customizer Usage</div>
              </div>
              <div className="text-center space-y-2">
                <div className="text-3xl font-bold text-green-600">+50%</div>
                <div className="text-sm text-gray-600 bg-white">Creator Sign-ups</div>
              </div>
              <div className="text-center space-y-2">
                <div className="text-3xl font-bold text-blue-600">+25%</div>
                <div className="text-sm text-gray-600 bg-white">Mobile Conversion</div>
              </div>
            </div>
          </div>
        </div>
