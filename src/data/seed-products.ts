...
import { Product, Material, Gemstone, SizeOption, CreatorAttribution } from '../types/product'
...
export const CREATOR_PROFILES = {
  maya_jewels: {
    ...
    collaborationType: 'design' as const,
    commissionRate: 0.30,
...
function createProduct(
  ...
  basePrice: number,
  description: string,
  navigationCategories: string[], // Maps to Gen Z navigation structure
  overrides: Partial<Omit<Product, 'metadata'>> & { metadata?: Partial<Product['metadata']> } = {}
  ...
  return {
    ...
    customization: {
      ...
      gemstones: ['rings', 'earrings'].includes(category) ? STANDARD_GEMSTONES : undefined,
    ...
    metadata: {
      featured: overrides.metadata?.featured ?? false,
      bestseller: overrides.metadata?.bestseller ?? false,
      newArrival: overrides.metadata?.newArrival ?? true,
      limitedEdition: overrides.metadata?.limitedEdition ?? false,
      status: overrides.metadata?.status ?? 'active' as const,
      collections: overrides.metadata?.collections ?? ['Gen Z'],
      tags: overrides.metadata?.tags ?? ['sustainable', 'lab-grown', 'customizable', ...navigationCategories],
      difficulty: overrides.metadata?.difficulty ?? 'beginner' as const,
      ...(overrides.metadata?.sustainabilityImpact && { sustainabilityImpact: overrides.metadata.sustainabilityImpact })
    } as Product['metadata'],
    analytics: {
...
function addSustainabilityImpact(product: any, impact: {
...
export const SEED_PRODUCTS: Omit<Product, '_id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  createProduct(
    ...
    'engagement-rings',
    1850,
    'The ring that says forever, designed for couples changing the world together. Timeless solitaire design with maximum brilliance. 100% Conflict-Free Lab-grown diamonds with identical beauty to mined stones. Master-crafted luxury that aligns with your values.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
        featured: true, 
        bestseller: true, 
  ...
  createProduct(
    ...
    'engagement-rings',
    2400,
    'Your love story deserves a spotlight. Halo setting amplifies brilliance with accent diamonds surrounding the center stone. 100% Conflict-Free Lab-grown diamonds with identical beauty to mined stones. Supporting ocean cleanup initiatives with every purchase.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    'Sustainable Three-Stone Ring',
    'rings',
    'engagement-rings',
    3000,
    'Past, present, future - all sustainable. Created by @maya_jewels for couples who care about their impact.',
    ['creator-community', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.maya_jewels,
      metadata: { 
  ...
  createProduct(
    'Conscious Cushion Cut Ring',
    'rings',
    'engagement-rings',
    2200,
    'Vintage vibes, modern values. This cushion cut beauty proves you don\'t have to compromise on style to make ethical choices.',
    ['shop-your-values', 'create-your-vibe'],
    {
      metadata: { 
  ...
  createProduct(
    'Promise of Tomorrow Ring',
    'rings',
    'fashion-rings',
    650,
    'A promise that your love is as infinite as your commitment to the planet. Designed for the generation that believes in forever.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    'Infinity Promise Band',
    'rings',
    'fashion-rings',
    780,
    'Created by @eco_elegance for relationships that grow stronger every day. Made with 100% recycled metals.',
    ['creator-community', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.eco_elegance,
      metadata: { 
  ...
  createProduct(
    'Daily Dose Stackable Ring',
    'rings',
    'fashion-rings',
    320,
    'Your everyday reminder that small choices make big differences. Stack them, mix them, make them yours.',
    ['create-your-vibe'],
    {
      metadata: { 
        bestseller: true,
  ...
  createProduct(
    ...
    'fashion-rings',
    420,
    '@maya_jewels\' signature style: maximum impact, minimal footprint. Perfect for the understated rebel.',
    ['creator-community'],
    {
      creator: CREATOR_PROFILES.maya_jewels,
      metadata: { 
  ...
  createProduct(
    'Bold Statement Cocktail Ring',
    'rings',
    'fashion-rings',
    1200,
    'For when you want your jewelry to do the talking. This showstopper is made from recycled gold and lab-grown stones.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    'Geometric Power Ring',
    'rings',
    'fashion-rings',
    950,
    '@eco_elegance\'s angular masterpiece that breaks all the rules. For the rebels who wear their values.',
    ['creator-community'],
    {
      creator: CREATOR_PROFILES.eco_elegance,
      metadata: { 
  ...
  createProduct(
    'Signature Diamond Pendant',
    'necklaces',
    'pendants',
    890,
    'The necklace that goes with everything and stands for something. Lab-grown diamond in recycled gold.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
        bestseller: true,
  ...
  createProduct(
    ...
    'pendants',
    720,
    '@maya_jewels designed this piece for the romantics who believe love can change the world.',
    ['creator-community'],
    {
      creator: CREATOR_PROFILES.maya_jewels,
      metadata: { 
  ...
  createProduct(
    ...
    'pendants',
    650,
    'Inspired by the waves we\'re working to clean. Every purchase removes plastic from our oceans.',
    ['shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'chains',
    450,
    'Three chains, infinite possibilities. Created for the generation that writes their own rules.',
    ['create-your-vibe'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'chains',
    1850,
    '@eco_elegance\'s luxury piece that proves sustainability and glamour are best friends.',
    ['creator-community', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.eco_elegance,
      metadata: { 
  ...
  createProduct(
    'Power Statement Collar',
    'necklaces',
    'statement-necklaces',
    1400,
    'For the moments when you need to remind the room who you are. Bold, sustainable, unapologetic.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    'Cascade Drop Necklace',
    'necklaces',
    'statement-necklaces',
    980,
    'Movement and meaning in every wear. This cascading design flows like water, cleans like purpose.',
    ['shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    'Story Layering Necklace',
    'necklaces',
    'chains',
    320,
    'Every layer tells your story. @maya_jewels\' delicate design for the storytellers.',
    ['creator-community'],
    {
      creator: CREATOR_PROFILES.maya_jewels,
      metadata: { 
  ...
  createProduct(
    ...
    'studs',
    780,
    'The earrings that started it all. Lab-grown diamonds that shine as bright as your future.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
        bestseller: true,
  ...
  createProduct(
    'Geometric Stud Collection',
    'earrings',
    'studs',
    450,
    '@eco_elegance\'s modern take on studs. Angular, bold, and completely sustainable.',
    ['creator-community'],
    {
      creator: CREATOR_PROFILES.eco_elegance,
      metadata: { 
  ...
  createProduct(
    'Minimalist Dot Studs',
    'earrings',
    'studs',
    280,
    'Less is more, impact is everything. @maya_jewels\' signature minimalism meets maximum values.',
    ['creator-community'],
    {
      creator: CREATOR_PROFILES.maya_jewels,
      metadata: { 
  ...
  createProduct(
    'Sustainable Huggie Hoops',
    'earrings',
    'hoops',
    520,
    'Hugs for your ears, love for the planet. Made from 100% recycled precious metals.',
    ['shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'hoops',
    680,
    'Go big or go home. These hoops make a statement about style AND sustainability.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Statement', 'Sustainable'],
  ...
  createProduct(
    'Flowing Drop Earrings',
    'earrings',
    'drops',
    850,
    'Movement with meaning. @eco_elegance designed these drops to flow like the change we\'re creating.',
    ['creator-community', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.eco_elegance,
      metadata: { 
  ...
  createProduct(
    ...
    'drops',
    1200,
    'For the moments worth celebrating. Handcrafted drama that supports artisan communities worldwide.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
        featured: true,
  ...
  createProduct(
    'Sustainable Chain Bracelet',
    'bracelets',
    'chain-bracelets',
    380,
    'The bracelet that links your style to your values. Perfect for stacking or standing alone.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'chain-bracelets',
    560,
    '@maya_jewels\' take on infinite possibilities. Delicate links for the dreamers and doers.',
    ['creator-community'],
    {
      creator: CREATOR_PROFILES.maya_jewels,
      metadata: { 
  ...
  createProduct(
    ...
    'bangles',
    720,
    'Wear your power on your sleeve. This cuff is made from recycled gold and supports women artisans.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    'Story Charm Bracelet',
    'bracelets',
    'charm-bracelets',
    450,
    'Collect moments, not things. @eco_elegance designed this charm bracelet for the memory makers.',
    ['creator-community'],
    {
      creator: CREATOR_PROFILES.eco_elegance,
      metadata: { 
  ...
  createProduct(
    ...
    'tennis-bracelets',
    1650,
    'Classic elegance meets conscious choices. Lab-grown diamonds in recycled gold for the luxury lovers who care.',
    ['shop-your-values'],
    {
      metadata: { 
        featured: true,
  ...
  createProduct(
    ...
    'engagement-rings',
    750,
    'Classic round brilliant cut moissanite with fire that rivals any diamond. @moissanite_maven\'s signature design for conscious luxury.',
    ['moissanite', 'create-your-vibe'],
    {
      creator: CREATOR_PROFILES.moissanite_maven,
      metadata: { 
  ...
  createProduct(
    ...
    'engagement-rings',
    850,
    'Modern princess cut with exceptional brilliance. Square perfection that breaks all the diamond rules.',
    ['moissanite', 'create-your-vibe'],
    {
      metadata: { 
        collections: ['Moissanite', 'Essential Collection'],
  ...
  createProduct(
    ...
    'engagement-rings',
    950,
    'Elongated elegance with brilliant fire. This oval moissanite maximizes visual carat weight while staying budget-conscious.',
    ['moissanite', 'create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Moissanite', 'Essential Collection'],
        sustainabilityImpact: { carbonOffset: 3, treesPlanted: 2 }
  ...
  createProduct(
    ...
    'engagement-rings',
    800,
    'Sophisticated step cut showcasing moissanite\'s clarity. Vintage-inspired with modern values.',
    ['moissanite', 'create-your-vibe'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'engagement-rings',
    900,
    'Soft cushion cut with romantic appeal. @moissanite_maven designed this for the old-soul romantics.',
    ['moissanite', 'create-your-vibe'],
    {
      creator: CREATOR_PROFILES.moissanite_maven,
      metadata: { 
  ...
  createProduct(
    ...
    'engagement-rings',
    1100,
    'Center moissanite surrounded by smaller moissanite accent stones. Maximum sparkle, maximum impact.',
    ['moissanite', 'create-your-vibe'],
    {
      metadata: { 
        collections: ['Moissanite', 'Essential Collection'],
  ...
  createProduct(
    ...
    'engagement-rings',
    1150,
    'Past, present, future - all sparkling with lab-created brilliance. Three moissanite stones tell your love story.',
    ['moissanite', 'create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Moissanite', 'Essential Collection'],
  ...
  createProduct(
    ...
    'pendants',
    650,
    'Single moissanite pendant that catches light from every angle. Simple elegance that goes everywhere.',
    ['moissanite', 'create-your-vibe'],
    {
      metadata: { 
        bestseller: true,
  ...
  createProduct(
    'Moissanite Pendant Set',
    'necklaces',
    'pendants',
    780,
    'Coordinated pendant and chain set featuring brilliant moissanite. @moissanite_maven\'s everyday luxury solution.',
    ['moissanite', 'create-your-vibe'],
    {
      creator: CREATOR_PROFILES.moissanite_maven,
      metadata: { 
  ...
  createProduct(
    'Moissanite Chain Necklace',
    'necklaces',
    'chains',
    520,
    'Delicate chain with small moissanite stations. Perfect for layering or wearing solo.',
    ['moissanite', 'create-your-vibe'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'studs',
    580,
    'Classic moissanite studs with incredible fire and brilliance. Your everyday sparkle upgrade.',
    ['moissanite', 'create-your-vibe'],
    {
      metadata: { 
        bestseller: true,
  ...
  createProduct(
    ...
    'drops',
    680,
    'Graceful drops that dance with light. @moissanite_maven designed these for special moments.',
    ['moissanite', 'create-your-vibe'],
    {
      creator: CREATOR_PROFILES.moissanite_maven,
      metadata: { 
  ...
  createProduct(
    ...
    'tennis-bracelets',
    1200,
    'Line of brilliant moissanite stones creating continuous sparkle. Luxury that makes sense.',
    ['moissanite', 'create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
        featured: true,
  ...
  createProduct(
    ...
    'wedding-bands',
    420,
    'Delicate moissanite band perfect for stacking or wearing alone. Affordable luxury for your forever.',
    ['moissanite', 'create-your-vibe'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'wedding-bands',
    850,
    'Celebrate your milestones with brilliant moissanite. Five-stone anniversary band that tells your story.',
    ['moissanite', 'create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    'Men\'s Lab Diamond Wedding Band',
    'rings',
    'wedding-bands',
    1800,
    'Masculine elegance with lab-grown diamonds. @modern_classics designed this for the modern groom who values substance.',
    ['mens-jewelry', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.modern_classics,
      metadata: { 
  ...
  createProduct(
    ...
    'fashion-rings',
    1200,
    'Classic signet ring reimagined in sustainable materials. Perfect for personalization with engraving.',
    ['mens-jewelry', 'create-your-vibe'],
    {
      metadata: { 
  ...
  createProduct(
    'Men\'s Moissanite Ring',
    'rings',
    'fashion-rings',
    800,
    'Bold moissanite statement ring for the man who breaks conventions. @modern_classics\' signature masculine design.',
    ['mens-jewelry', 'moissanite', 'create-your-vibe'],
    {
      creator: CREATOR_PROFILES.modern_classics,
      metadata: { 
  ...
  createProduct(
    ...
    'chain-bracelets',
    750,
    'Substantial chain bracelet in recycled metals. Strength and style for the conscious man.',
    ['mens-jewelry', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Men\'s Jewelry', 'Signature Collection'],
  ...
  createProduct(
    ...
    'pendants',
    950,
    'Minimalist pendant on substantial chain. @modern_classics created this for the understated powerhouse.',
    ['mens-jewelry', 'create-your-vibe'],
    {
      creator: CREATOR_PROFILES.modern_classics,
      metadata: { 
  ...
  createProduct(
    ...
    'accessories',
    650,
    'Sophisticated cufflinks in sustainable metals. The finishing touch for the conscious professional.',
    ['mens-jewelry', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'wedding-bands',
    720,
    'Timeless 14K gold band that never goes out of style. Sustainable luxury for your forever commitment.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
        bestseller: true,
  ...
  createProduct(
    ...
    'wedding-bands',
    1850,
    'Premium platinum band for the ultimate luxury experience. @sustainable_sparkle\'s choice for discerning couples.',
    ['shop-your-values'],
    {
      creator: CREATOR_PROFILES.sustainable_sparkle,
      metadata: { 
  ...
  createProduct(
    'Vintage-Style Wedding Band',
    'rings',
    'wedding-bands',
    950,
    'Art deco inspired wedding band with intricate detailing. Old-world charm meets modern sustainability.',
    ['create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    'Stackable Wedding Band Set',
    'rings',
    'wedding-bands',
    1200,
    'Three coordinated bands designed for stacking. @maya_jewels created this for the modern romantic.',
    ['create-your-vibe'],
    {
      creator: CREATOR_PROFILES.maya_jewels,
      metadata: { 
  ...
  createProduct(
    'Premium Grade Lab Diamond Ring (D-F, VVS)',
    'rings',
    'engagement-rings',
    3800,
    'The pinnacle of lab-grown diamond excellence. @sustainable_sparkle\'s choice for the ultimate luxury experience.',
    ['lab-diamonds', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.sustainable_sparkle,
      metadata: { 
        featured: true,
  ...
  createProduct(
    'Lab Diamond Three-Stone Ring',
    'rings',
    'engagement-rings',
    4200,
    'Past, present, future - all captured in premium lab-grown diamonds. The ultimate symbol of timeless love.',
    ['lab-diamonds', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Lab Diamonds', 'Premium Collection'],
  ...
  createProduct(
    ...
    'engagement-rings',
    4500,
    'Design your perfect ring with premium lab-grown diamonds. Unlimited customization for your unique love story.',
    ['lab-diamonds', 'create-your-vibe', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'engagement-rings',
    3500,
    'Center lab diamond surrounded by accent diamonds. @sustainable_sparkle designed this for maximum brilliance.',
    ['lab-diamonds', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.sustainable_sparkle,
      metadata: { 
  ...
  createProduct(
    'Excellent Grade Lab Diamond Ring (G-H, VS)',
    'rings',
    'engagement-rings',
    2400,
    'Beautiful lab-grown diamonds with excellent value. Perfect balance of quality and conscious pricing.',
    ['lab-diamonds', 'shop-your-values'],
    {
      metadata: { 
        bestseller: true,
  ...
  createProduct(
    ...
    'wedding-bands',
    1800,
    'Classic lab diamond wedding band that complements any engagement ring. Timeless elegance, sustainable choice.',
    ['lab-diamonds', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    'Lab Diamond Anniversary Ring',
    'rings',
    'fashion-rings',
    3100,
    'Celebrate your milestones with lab-grown diamond brilliance. Five stones representing your journey together.',
    ['lab-diamonds', 'shop-your-values'],
    {
      metadata: { 
  ...
  createProduct(
    ...
    'tennis-bracelets',
    2900,
    'Continuous line of lab-grown diamonds creating spectacular sparkle. @sustainable_sparkle\'s signature piece.',
    ['lab-diamonds', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.sustainable_sparkle,
      metadata: { 
  ...
  createProduct(
    ...
    'chains',
    3200,
    'Graduated lab diamonds creating elegant neckline brilliance. The ultimate luxury statement piece.',
    ['lab-diamonds', 'shop-your-values'],
    {
      metadata: { 
        featured: true,
  ...
  createProduct(
    'Lab Diamond Stud Earrings (1ct)',
    'earrings',
    'studs',
    2800,
    'Classic 1-carat lab diamond studs that elevate any look. Timeless elegance with modern values.',
    ['lab-diamonds', 'shop-your-values'],
    {
      metadata: { 
        bestseller: true,
  ...
  createProduct(
    ...
    'pendants',
    2200,
    'Single lab diamond pendant that catches light beautifully. Elegant simplicity with sustainable luxury.',
    ['lab-diamonds', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Lab Diamonds', 'Signature Collection'],
  ...
  createProduct(
    ...
    'drops',
    2600,
    'Graceful lab diamond drops that move with elegant beauty. @sustainable_sparkle\'s evening luxury choice.',
    ['lab-diamonds', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.sustainable_sparkle,
      metadata: { 
  ...
  createProduct(
    ...
    'fashion-rings',
    1200,
    'Vivid green lab-grown emerald that rivals the finest Colombian stones. @sustainable_sparkle\'s colorful luxury.',
    ['lab-gems', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.sustainable_sparkle,
      metadata: { 
  ...
  createProduct(
    'Lab Emerald Earrings',
    'earrings',
    'studs',
    1050,
    'Brilliant green emerald studs that add color to any outfit. Sophisticated alternative to traditional diamonds.',
    ['lab-gems', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Lab Gems', 'Signature Collection'],
  ...
  createProduct(
    'Lab Ruby Pendant Necklace',
    'necklaces',
    'pendants',
    1100,
    'Passionate red lab-grown ruby pendant. The symbol of love and strength in sustainable luxury.',
    ['lab-gems', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Lab Gems', 'Signature Collection'],
  ...
  createProduct(
    ...
    'fashion-rings',
    1400,
    'Bold lab-grown ruby statement ring. @sustainable_sparkle designed this for the passionate and powerful.',
    ['lab-gems', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.sustainable_sparkle,
      metadata: { 
  ...
  createProduct(
    'Lab Sapphire Earrings',
    'earrings',
    'studs',
    950,
    'Royal blue lab-grown sapphire earrings that command attention. Classic elegance with modern values.',
    ['lab-gems', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Lab Gems', 'Signature Collection'],
  ...
  createProduct(
    'Lab Sapphire Necklace',
    'necklaces',
    'pendants',
    1150,
    'Deep blue lab-grown sapphire pendant on delicate chain. Timeless sophistication for the conscious consumer.',
    ['lab-gems', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Lab Gems', 'Signature Collection'],
  ...
  createProduct(
    ...
    'fashion-rings',
    900,
    'Serene blue lab-grown aquamarine ring inspired by ocean depths. Calming beauty with sustainable impact.',
    ['lab-gems', 'shop-your-values'],
    {
      metadata: { 
        collections: ['Lab Gems', 'Signature Collection'],
  ...
  createProduct(
    'Lab Tanzanite Pendant',
    'necklaces',
    'pendants',
    1300,
    'Rare blue-purple lab-grown tanzanite pendant. @sustainable_sparkle\'s choice for the unique and extraordinary.',
    ['lab-gems', 'shop-your-values'],
    {
      creator: CREATOR_PROFILES.sustainable_sparkle,
      metadata: { 
...
export const NAVIGATION_CATEGORY_MAPPING = {
  'create-your-vibe': SEED_PRODUCTS.filter(p => p.metadata.tags.includes('create-your-vibe')),
  'shop-your-values': SEED_PRODUCTS.filter(p => p.metadata.tags.includes('shop-your-values')),
  'creator-community': SEED_PRODUCTS.filter(p => p.metadata.tags.includes('creator-community'))
}
...
export const PRODUCT_DISTRIBUTION = {
  ...
  navigation_mapping: {
    'create-your-vibe': NAVIGATION_CATEGORY_MAPPING['create-your-vibe'].length,
    'shop-your-values': NAVIGATION_CATEGORY_MAPPING['shop-your-values'].length,
    'creator-community': NAVIGATION_CATEGORY_MAPPING['creator-community'].length,
    'moissanite': 15,
    'lab-diamonds': 12,
    'lab-gems': 8,
    'mens-jewelry': 6
