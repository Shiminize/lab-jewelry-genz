/**
 * Homepage Components - Centralized Exports
 * GlowGlitch Homepage Section Components
 */
...
// Re-export any compact or variant components
export { FeaturedProductsCompact } from './FeaturedProductsSection'
...
export type { SustainabilityStorySectionProps } from './SustainabilityStorySection'