...
export function GeneticMegaMenu({ onClose }: GeneticMegaMenuProps) {
  ...
  return (
    <div 
      className="absolute top-full left-0 w-full bg-background shadow-2xl border-t border-amber-200 z-40"
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-3">
            <div className="space-y-2">
              <h3 className="text-sm font-semibold text-aurora-nav-text mb-4 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isActive 
                        ...
                        : "hover:bg-aurora-nav-hover border-transparent text-aurora-nav-muted hover:text-aurora-nav-text"
                    )}
                  >
                    <div className="flex items-center gap-3">
                      <Icon className={cn("w-5 h-5", isActive ? "text-amber-600" : "text-aurora-nav-muted")} />
                      <div className="flex-1">
                        <div className="font-medium text-sm">{category.name}</div>
                        <div className="text-xs text-aurora-nav-muted">{category.description}</div>
                      </div>
          ...
          <div className="col-span-6">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-aurora-nav-text">{currentCategory.name}</h2>
                  <p className="text-sm text-aurora-nav-muted">{currentCategory.description}</p>
                </div>
                <Badge className={cn(
                  "ml-auto",
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-aurora-nav-text">Genetic Compatibility</span>
                ...
                <Progress 
                  ...
                  className="h-2 bg-aurora-nav-border"
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              {currentCategory.products.map((product) => (
                <Card key={product.id} className="group hover:shadow-lg transition-all duration-300 border-aurora-nav-border hover:border-amber-200"
                  <CardContent className="p-4">
                    <div className="aspect-square bg-aurora-nav-surface rounded-lg mb-3 relative overflow-hidden"
                    ...
                    <div className="space-y-2">
                      <h3 className="font-semibold text-sm text-aurora-nav-text group-hover:text-amber-700 transition-colors"
                        {product.name}
                      </h3>
                      ...
                      <div className="text-lg font-bold text-aurora-nav-text">{product.price}</div>
                      
                      <ul className="text-xs text-aurora-nav-muted space-y-1"
                      ...
                      <div className="flex gap-2 pt-2">
                        ...
                        <Button size="sm" variant="outline" className="border-aurora-nav-border"
          ...
          <div className="col-span-3">
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-semibold text-aurora-nav-text mb-3">Quick Actions</h3>
              ...
              <Button variant="outline" className="w-full justify-between border-aurora-nav-border"
                <div className="flex items-center gap-2">
            ...
            {/* Social Proof */}
            <Card className="mt-6 border-aurora-nav-border"
              <CardContent className="p-4">
                <h4 className="text-sm font-semibold text-aurora-nav-text mb-3">Recent Genetic Matches</h4>
                <div className="space-y-3 text-xs text-aurora-nav-muted">
                  <div className="flex items-center gap-2">
