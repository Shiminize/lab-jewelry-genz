...
export function LuxuryMegaMenu({ activeCategory, onClose }: LuxuryMegaMenuProps) {
  ...
  return (
    <div 
      className="absolute top-full left-0 w-full bg-background shadow-2xl border-t border-border z-[60]"
                  ...
                  <CardContent className="p-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs text-aurora-nav-muted font-body">({product.reviews})</span>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {product.oldPrice && (
                          <span className="text-xs text-aurora-nav-muted line-through font-body">{product.oldPrice}</span>
                        )}
                      </div>
                    </div>
                  </CardContent>
