          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center space-x-2">
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-background rounded-full border-2 border-accent" />
              </div>
              <div>
                <h1 className="text-2xl font-headline text-foreground">
                  GlowGlitch
                </h1>
                <p className="text-xs text-aurora-nav-muted tracking-widest uppercase font-body">Luxury Jewelry</p>
              </div>
            </Link>
