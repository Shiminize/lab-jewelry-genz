...
export function ScientificHeader({ onMegaMenuToggle, onMobileMenuToggle, showMegaMenu }: ScientificHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-amber-200/50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/90 shadow-lg">
            ...
            {navigationItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {hoveredItem === item.id && (
                    <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-64 p-3 bg-background rounded-lg shadow-xl border border-amber-200 z-50">
