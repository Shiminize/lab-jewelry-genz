              ...
              {consciousCategories.map((category, index) => (
                <div key={index} className="relative">
                  <button
                    ...
                    className="flex items-center space-x-1 text-foreground bg-white hover:text-accent transition-colors"
                  >
                  ...
                  {activeDropdown === category.title && (
                    ...
                    >
                      <div className="p-6">
                        <H3 className="text-foreground bg-white mb-2">{category.title}</H3>
                        ...
                        <div className="space-y-2 mb-4">
                          {category.products.map((product, productIndex) => (
                            <button
                              key={productIndex}
                              className="block w-full text-left text-foreground bg-white hover:text-accent text-sm transition-colors"
                            >
                              {product}
                            </button>
                          ))}
