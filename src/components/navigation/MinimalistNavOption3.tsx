          ...
          <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
                    ...
                    <div className="space-y-2">
                      {smartRecommendations.map((rec, index) => (
                        <div key={index} className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50">
                          <div>
                            <div className="text-sm font-medium text-foreground bg-white">{rec.product}</div>
                            <div className="text-xs text-gray-600 bg-white">Save {rec.savings}</div>
                          </div>
              ...
              {hoveredItem === 'designer' && (
                <div className="absolute top-full left-0 mt-1 w-72 bg-white rounded-xl shadow-lg border border-gray-100 p-4">
                  <div className="space-y-3">
                    <h3 className="text-foreground bg-white font-semibold">Intelligent 3D Customizer</h3>
                    
                    <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-3">
                      <div className="text-sm space-y-2">
                        <div className="flex items-center justify-between">
                          <span className="text-gray-600 bg-background">Budget Optimizer</span>
                          <span className="font-medium text-foreground bg-background">ON</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-gray-600 bg-background">AI Suggestions</span>
                          <span className="text-green-600 font-medium">Active</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-gray-600 bg-background">Best Value Mode</span>
            ...
            >
              ...
              {hoveredItem === 'vault' && (
                <div className="absolute top-full left-0 mt-1 w-80 bg-white rounded-xl shadow-lg border border-gray-100 p-4">
                  <div className="space-y-4">
                    <h3 className="text-foreground bg-white font-semibold">Best Bang for Buck</h3>
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-3">
                      <div className="text-sm space-y-2">
                        ...
                        <div className="text-xs text-gray-600 bg-background">
                    ...
                    <div className="text-sm">
                      <div className="text-gray-600 bg-white mb-2">Upgrade Path:</div>
                      <div className="flex items-center space-x-2 text-xs">
                        <span className="px-2 py-1 bg-gray-100 rounded">925 Silver</span>
                        <span>→</span>
            ...
            >
              ...
              {hoveredItem === 'impact' && (
                <div className="absolute top-full right-0 mt-1 w-72 bg-white rounded-xl shadow-lg border border-gray-100 p-4">
                  <div className="space-y-3">
                    <h3 className="text-foreground bg-white font-semibold">Your Impact Score</h3>
                    
                    <div className="text-center py-3">
                      <div className="text-3xl font-bold text-purple-600">847</div>
                      <div className="text-xs text-gray-600 bg-white">Impact Points</div>
                    </div>
                    
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center justify-between">
                        <span className="text-gray-600 bg-white">CO₂ Saved</span>
                        <span className="font-medium text-green-600">2.3 tons</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-gray-600 bg-white">Water Saved</span>
                        <span className="font-medium text-blue-600">45,000 gal</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-gray-600 bg-white">Conscious Choices</span>
                        <span className="font-medium text-purple-600">12</span>
                      </div>
                    </div>
                    
                    <div className="text-xs text-center text-gray-600 bg-white pt-2 border-t border-gray-100">
          ...
          <div className={cn(
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 bg-background mt-1">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-2">
              {smartRecommendations.slice(0, 2).map((rec, index) => (
                <Link key={index} href={`/product/${rec.product.toLowerCase().replace(/\s+/g, '-')}`}>
                  <div className="bg-white rounded-lg border border-gray-100 p-3 flex items-center justify-between hover:border-blue-200 transition-colors">
                    <div>
                      <div className="font-medium text-foreground bg-white">{rec.product}</div>
                      <div className="text-xs text-gray-600 bg-white">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link href="/smart-designer" className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-3 border border-yellow-100">
                ...
                <div className="text-xs text-gray-600 bg-background">AI-powered</div>
              </Link>
              <Link href="/value-vault" className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-3 border border-green-100">
                ...
                <div className="text-xs text-gray-600 bg-background">${dynamicPrice} Moissanite</div>
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-3 border border-purple-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-gray-600 bg-background mt-1">2.3 tons CO₂ saved</div>
                </div>
