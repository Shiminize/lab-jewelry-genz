        ...
        <div className="hidden lg:block absolute top-full right-4 mt-2">
          {cartItemCount === 0 && isProfileComplete && (
            <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-3 max-w-xs">
              <div className="text-xs text-gray-600 bg-white mb-1">Recommended for you:</div>
              <div className="text-sm font-medium text-foreground bg-white">
                {contextValue.recommendedProducts[0]?.name}
              </div>
              <div className="text-xs text-cta bg-white mt-1">
...
export const PersonalizedBanner = ({ variant }: { variant: string }) => {
  ...
  return (
    <div className={cn('bg-gradient-to-r border-b border-gray-100', getBannerGradient())}>
