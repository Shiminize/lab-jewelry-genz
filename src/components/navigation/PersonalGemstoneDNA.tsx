...
const EnhancedNavigationItem = ({ 
  ...
  return (
    ...
    >
      <Link href={item.href} className="group flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-200 hover:bg-white/50">
        <SVGIcon 
          svgString={item.icon} 
          className={cn(
            ...
            !isGenomeScan && !isMoissanite && "text-gray-600 group-hover:text-blue-600"
          )} 
        />
        <span className={cn(
        ...
        {item.badge && (
          <span className={cn(
            ...
            !isGenomeScan && !isMoissanite && "bg-gray-100 text-gray-700"
          )}>
            {item.badge}
          </span>
        )}
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg space-y-3">
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <div className="bg-white p-2 rounded border">
                  ...
                  <div className="text-xs text-gray-600">Elongated</div>
                </div>
                <div className="bg-white p-2 rounded border">
                  <div className="font-medium text-green-700">Princess Cut</div>
                  <div className="text-xs text-gray-600">Square</div>
                </div>
                <div className="bg-white p-2 rounded border">
            ...
            <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg space-y-3">
              <div className="space-y-2">
                <div className="flex justify-between items-center p-2 bg-white rounded border">
                  ...
                  <span className="text-xs text-gray-600">Flawless</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-white rounded border">
                  <span className="text-sm font-medium">Excellent Grade (G-H, VS)</span>
                  <span className="text-xs text-gray-600">Near perfect</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-white rounded border">
                  <span className="text-sm font-medium">Good Grade (I-J, SI)</span>
                  <span className="text-xs text-gray-600">Great value</span>
                </div>
              </div>
            ...
            <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg space-y-3">
              <div className="grid grid-cols-1 gap-2 text-sm">
                <div className="flex items-center justify-between p-2 bg-white rounded border">
                  ...
                  <span className="text-xs text-gray-600">Calming</span>
                </div>
                <div className="flex items-center justify-between p-2 bg-white rounded border">
                  <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-600">Wisdom</span>
                </div>
                <div className="flex items-center justify-between p-2 bg-white rounded border">
                  <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-600">Passion</span>
                </div>
              </div>
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-background z-50 lg:hidden transform transition-transform duration-300 ease-out translate-y-0 max-h-[80vh] overflow-y-auto">
        {/* Handle Bar */}
        <div className="w-full bg-gray-100 py-2 flex justify-center">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 bg-background">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-green-200 p-4 shadow-lg">
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-foreground bg-white font-semibold flex items-center space-x-2">
                <SVGIcon 
            ...
            <p className="text-sm text-gray-600 bg-white mb-2">
              {recommendedProducts[0]?.name || 'Precision Moissanite + Silver Matrix'}
            </p>
            <p className="text-xs text-green-600 bg-white mb-3 font-medium">
          ...
          <div className="space-y-3">
            <h4 className="text-foreground font-semibold text-sm border-b border-gray-200 pb-2">
            ...
            {enhancedNavigationData.map((navItem) => {
              ...
              return (
                <div key={navItem.id} className="bg-white rounded-lg border shadow-sm overflow-hidden">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      !isGenomeScan && !isMoissanite && "border-gray-200"
                    )}
                  >
                    <div className="flex items-center space-x-3">
                      <div className={cn(
                        ...
                        !isGenomeScan && !isMoissanite && "bg-gray-100"
                      )}>
                        <SVGIcon 
                          ...
                          className={cn(
                            ...
                            isGenomeScan && "text-blue-600 animate-pulse",
                            isMoissanite && "text-green-600",
                            !isGenomeScan && !isMoissanite && "text-gray-600"
                          )} 
                        />
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="text-foreground bg-white font-medium text-sm">{navItem.label}</div>
                        {navItem.badge && (
                          <div className={cn(
                        ...
                        {isGenomeScan && (
                          <div className="text-xs text-blue-500 bg-white mt-1">
    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-gray-200">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-foreground bg-white font-bold text-xl flex items-center space-x-2">
            <SVGIcon 
              svgString={enhancedNavigationData[0].icon} 
