  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-8">
        ...
        {isGenomeScan && (
          <div className="mb-6 bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-blue-200">
            ...
            <div className="space-y-2">
              ...
              <BodyText size="xs" className="text-gray-600">
                {isAnalyzing 
          ...
          <div className="col-span-4 space-y-6">
                  ...
                  {item.megaMenuContent.featuredProducts.map((product) => (
                    <Link
                      ...
                      className={cn(
                        ...
                        isGenomeScan 
                          ? "bg-white/80 hover:bg-white border border-blue-200 hover:border-green-300 hover:shadow-lg focus:ring-blue-500"
            ...
            {isGenomeScan && (
              <div className="bg-white/80 rounded-lg p-4 border border-green-200">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <BodyText size="xs" className="text-gray-600">Active Sequences</BodyText>
                    <BodyText size="xs" className="font-bold text-green-600">23/23</BodyText>
                  </div>
                  <div className="flex items-center justify-between">
                    <BodyText size="xs" className="text-gray-600">Molecular Sync</BodyText>
                    <BodyText size="xs" className="font-bold text-blue-600">99.7%</BodyText>
                  </div>
                  <div className="flex items-center justify-between">
                    <BodyText size="xs" className="text-gray-600">Lab Certification</BodyText>
