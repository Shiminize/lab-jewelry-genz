  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Legacy Aurora colors (for backward compatibility) - RGB format for opacity support
        background: '247 247 249', // Aurora Lunar Grey - RGB format for opacity modifiers
        foreground: '10 14 39',    // Aurora Deep Space - RGB format for opacity modifiers
        muted: '241 242 246',      // Aurora: Starlight Gray - RGB format for opacity modifiers
        accent: '196 69 105',      // Aurora: Crimson - RGB format for opacity modifiers
        'accent-secondary': '255 107 157', // Aurora: Pink - RGB format for opacity modifiers
        'accent-interactive': '196 69 105', // Aurora: Crimson - RGB format for opacity modifiers
      ...
      spacing: {
        ...
        'token-4xl': '6rem',      // --token-space-4xl (96px) - Luxury section spacing
        'token-5xl': '8rem',      // --token-space-5xl (128px) - Hero/showcase spacing
